...
function getBottlesCollection(firstX, firstY) {
    return [
        new Bottle (firstX + 0 * 100, firstY - 0 * 50),
        new Bottle (firstX + 1 * 100, firstY - 1 * 50),
        new Bottle (firstX + 2 * 100, firstY - 2 * 50),
        new Bottle (firstX + 3 * 100, firstY - 1 * 50),
        new Bottle (firstX + 4 * 100, firstY - 0 * 50)
...
function getLevelBottles() {
    ...
    let collection3 = getBottlesCollection(400, 350);
    let collection4 = getBottlesCollection(1200, 350);
    return collection1.concat(collection2, collection3, collection4);
}
